    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(related_name='related_ogclayer_categories', to='sections.section')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('set_min_zoom', models.IntegerField(default=0)),
                ('set_zoom_level', models.IntegerField(default=0)),
                ('categories', models.ManyToManyField(related_name='related_webgisproject_categories', to='sections.section')),
